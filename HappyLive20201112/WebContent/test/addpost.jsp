          ...
          <div id="content">
              <div id="post">
                  <div style="background:#3EADC5 ;height:30px;">
                      名稱：<input type="submit" id="shangtian" name="Submit3" style="border:none; background-color:#3EADC5; color:white;" value="選擇名稱" onclick="prom()" />
			...
			<input name="ok" type="button" id="ok" value="讚" onClick="hao();" style="width:50px;">
			</form>  				
			</div>
