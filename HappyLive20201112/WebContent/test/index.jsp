...
<title>index</title>
	...
	#footer {background-color:#FFA500;clear:both;text-align:center;width:100%;}
	h1 {margin-bottom:0;}
...
<body>
		...
		<div class="container"  style="font-family:Microsoft JhengHei;" background-border = "1px">
			...
			<div id="myCarousel" class="carousel slide"  style="width:100%;height:200px;border:1px #cccccc dashed;" data-ride="carousel">
		...
		<div id = "menu"  class="col-md-2">
			<div class="row">
				...
				<div><a href = "message.jsp">留言區</a></div>
