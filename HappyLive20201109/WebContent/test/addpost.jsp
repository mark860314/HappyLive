...
<title>addpost</title>
	...
	#menu {background-color:#5555FF;height:100%;width:12%;float:left;}
	#content {background-color:#EEEEEE;height:100%;width:88%;float:left;}
...
<body>
		...
		<div id="content" class="col-md-10">
			...
			<div class="row">
				<div>請輸入文章標題：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
				<div>請輸入文章內容：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
				<div>
				...
				<div class="dropdown">
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				    <a class="dropdown-item" href="#">愛情</a><br/>
				    <a class="dropdown-item" href="#">美食</a>
				 </div>
			  </div>
				
				</div>
				<div><button  style="width:50px;height:100%;background-color:#5555FF;" class = "mh5"><font color = "white">讚</font></button></div>
				<div><button  style="width:100px;height:100%;background-color:#5555FF;" class = "mh5"><font color = "white">確認送出</font></button></div>
				<div></div>
				<div></div>
				<div></div>
			</div>			
