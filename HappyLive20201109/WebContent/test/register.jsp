...
<body>
		...
		<div id="content" class="col-md-10">
			...
			<div class="row">
				<div>請輸入帳號：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
				<div>請輸入密碼：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
				<div>請再次輸入密碼：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
