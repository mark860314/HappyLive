...
<body>
		...
		<div id="content" class="col-md-10">
			...
			<div class="row">
				<div>隱私權政策</div>
				<div>1.  隱私權政策簡介</div>
				<div>本隱私權政策說明台灣連線股份有限公司</div>
				<div>1.蒐集您的個人資訊時，我們會清楚指出目的。</div>
				<div>2.個人資訊將被蒐集時，我們會事先通知您，以就個人資訊之蒐集、利用、揭露徵詢您的同意。</div>
				<div>3.我們僅會蒐集特定目的範圍內必要的個人資訊。</div>
				<div>4.除非經您的同意或基於法律要求，否則我們僅會針對蒐集目的利用或揭露您的個人資訊，且所蒐集之資訊僅會於蒐集目的完成之所需期間內保留。</div>
				<div>5.我們將盡力確保您個人資訊的精確性、完整性、和即時性。</div>
			</div>			
