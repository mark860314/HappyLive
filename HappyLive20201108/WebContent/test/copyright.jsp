...
<body>
		...
		<div class="container"  style="font-family:Microsoft JhengHei;" background-border = "1px">
			...
			<div class="row">
			  ...
			  <div class="col-md-10">1.  隱私權政策簡介</div>
			  ...
			  <div class="col-md-10">本隱私權政策說明台灣連線股份有限公司 </div>
			  <div class="col-md-2">註冊</div>
			  <div class="col-md-10">1.蒐集您的個人資訊時，我們會清楚指出目的。</div>
			  
			  <div class="col-md-2">登入</div>
			  <div class="col-md-10"><b>2.個人資訊將被蒐集時，我們會事先通知您，以就個人資訊之蒐集、利用、揭露徵詢您的同意。</b></div>
			  <div class="col-md-2">新增貼文</div>
			  <div class="col-md-10">3.我們僅會蒐集特定目的範圍內必要的個人資訊。</div>
			  
			  <div class="col-md-2">我的最愛</div>
			  <div class="col-md-10">4.除非經您的同意或基於法律要求，否則我們僅會針對蒐集目的利用或揭露您的個人資訊，且所蒐集之資訊僅會於蒐集目的完成之所需期間內保留。</div>
			  <div class="col-md-2">
			  ...
			  <div class="col-md-10">5.我們將盡力確保您個人資訊的精確性、完整性、和即時性。</div>
