...
<body>
		...
		<div class="container"  style="font-family:Microsoft JhengHei;" background-border = "1px">
			...
			<div class="row">
			  ...
			  <div class="col-md-10">請輸入帳號：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
			  ...
			  <div class="col-md-10">請輸入密碼：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
			  ...
			  <div class="col-md-10">請再次輸入密碼：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
			  <div class="col-md-2">註冊</div>
			  <div class="col-md-10"><button  style="width:50px;height:100%;background-color:#5555FF;" class = "mh5">確定</button></div>
			  ...
			  <div class="dropdown">
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				    <a class="dropdown-item" href="#">最讚看板</a>
