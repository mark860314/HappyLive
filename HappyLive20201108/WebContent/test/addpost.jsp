...
<body>
		...
		<div class="container"  style="font-family:Microsoft JhengHei;" background-border = "1px">
			...
			<div class="row">
			  ...
			  <div class="col-md-10">請輸入文章標題：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
			  ...
			  <div class="col-md-10">請輸入文章內容：<input type="text" name="欄位名稱" style="width:200px;height:100%;background-color:#EEEEEE;"></div>
			  ...
			  <div class="col-md-10"><button  style="width:50px;height:100%;background-color:#5555FF;" class = "mh5">確定送出</button></div>
